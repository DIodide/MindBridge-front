    ...
    <div className="min-h-screen bg-black text-white p-8 relative overflow-hidden">
      ...
      transition={{ duration: 0.8, delay: 0.2 }}>
        <h1 className="text-4xl font-bold text-center text-purple-400">Learning Hub</h1>
          ...
          <TextField fullWidth label = "What do you want to learn today?" placeholder="Your goal" variant="outlined" color="secondary" focused sx={{input:{color: 'white'}}} value ={goal} onChange={handlechange} />
